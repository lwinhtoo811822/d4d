...
for (var i = 0; i < pres.length; i++) {
  pres[i].addEventListener("dblclick", function () {
    ...
    function eraseText() {
     document.getElementById("resulted-textarea").value = "";
	}
