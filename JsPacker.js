<script>
  ...
  var base2 = {
    ...
    detect: new function(_) {
      var global = _;
    var jscript/*@cc_on=@_jscript_version@*/; if (_.navigator) {
        var element = document.createElement("span"); var userAgent = navigator.platform+" "+navigator.userAgent; if (!jscript)userAgent = userAgent.replace(/MSIE\s[\d.]+/, ""); userAgent = userAgent.replace(/([a-z])[\s\/](\d)/gi, "$1$2");
}

return function(a) {
    var r = false; var b = a.charAt(0) == "!"; if (b)a = a.slice(1); if (a.charAt(0) == "(") {
          try {
            eval("r=!!"+a);
}
...
new function(_) {
var detect = base2.detect; var slice = Array.slice || (function(b) {
      return function(a) {
        return b.apply(a, b.call(arguments, 1));
}})(Array.prototype.slice); var Undefined = K(),
    Null = K(null),
    True = K(true),
    False = K(false); var _0 = /%([1-9])/g; var _1 = /^\s\s*/; var _2 = /\s\s*$/; var _3 = /([\/()[\] {
}|*+-.,^$?\\])/g; var _4 = /eval/.test(detect)?/\bbase\s*\(/: /.*/; var _5 = ["constructor",
      "toString",
      "valueOf"]; var _6 = String(new RegExp); var _7 = 1; _8(); eval(base2.namespace); var _9 = function(a, b) {
base2.__prototyping = true; var c = new this; extend(c, a); delete base2.__prototyping; var d = c.constructor; function _10() {
        if (!base2.__prototyping) {
          if (this.constructor == arguments.callee || this.__constructing) {
            this.__constructing = true; d.apply(this, arguments); delete this.__constructing;
}
...
c.constructor = _10; for (var i in Base)_10[i] = this[i]; _10.toString = K(String(d)); _10.ancestor = this; _10.base = Undefined; _10.init = Undefined; extend(_10, b); _10.prototype = c; _10.init(); return _10;
};
...
constructor: function(d, e) {
          this.extend(e);
if (this.init)this.init(); if (this.name != "base2") {
            if (!this.parent)this.parent = base2; this.parent.addName(this.name, this); this.namespace = format("var %1=%2;", this.name, String(this).slice(1, -1));
}

var f = /[^\s,]+/g; if (d) {
d.imports = Array2.reduce(this.imports.match(f), function(a, b) {
              eval("var ns=base2."+b); assert(ns, format("Package not found: '%1'.", b)); return a += ns.namespace;
},base2.namespace+JavaScript.namespace); d.exports = Array2.reduce(this.exports.match(f), function(a, b) {
var c = this.name+"."+b; this.namespace += "var "+b+"="+c+";"; return a += "if(!"+c+")"+c+"="+b+";";
}, "",this);
}},
exports: "",
        imports: "",
...
if (!this[a]) {
            this[a] = b; this.exports += ", "+a; this.namespace += format("var %1=%2.%1;", a, this.name);
}},
...
extend: function(a, b) {
          var c = this.base();
_12(c, this); c.implement(a); extend(c, b); c.init(); return c;
},
implement: function(c) {
var d = this; if (typeof c == "function") {
            d.base(c); if (_11(Module, c)) {
              _12(d, c);
}}
...
function _12(a, b) {
for (var c in b) {
        var method = b[c]; if (!Module[c]&&typeof method=="function"&&method.call){a[c]=method;
}}};

var Enumerable=Module.extend( {
every: function(c,d,e){var f=true;
try{this.forEach(c,function(a,b){f=d.call(e,a,b,c);if(!f)throw StopIteration;
})}
...
var i=0;return this.reduce(d,function(a,b,c){if(e.call(f,b,c,d)){a[i++]=b;
}

return a;
},[]);
},invoke:function(b,c) {
var d=slice(arguments,2);return this.map(b,(typeof c=="function")?function(a){return(a==null)?undefined: c.apply(a,d);
}

:function(a) {
return(a==null)?undefined: a[c].apply(a,d);
})},map:function(c,d,e) {
var f=[],i=0;this.forEach(c,function(a,b){f[i++]=d.call(e,a,b,c);
});

return f;
},pluck:function(b,c) {
return this.map(b,function(a){return(a==null)?undefined: a[c];
})},reduce:function(c,d,e,f) {
var g=arguments.length>2;this.forEach(c,function(a,b){if(g){e=d.call(f,e,a,b,c);
}
...
var _14="#";var Map=Base.extend( {
constructor: function(a){this.merge(a);
},copy:delegate(copy),forEach:function(a,b) {
for(var c in this)if(c.charAt(0)==_14){a.call(b,this[c],c.slice(1),this);
}},get:function(a) {
return this[_14+a];
},getKeys:function() {
...
/*@cc_on@*//*@if(@_jscript_version<5.5)return $Legacy.has(this,_14+a);@else@*/
return _14+a in this;/*@end@*/;
},merge:function(b) {
var c=flip(this.put);forEach(arguments,function(a){forEach(a,c,this);
},this);return this;
},remove:function(a) {
delete this[_14+a];
},put:function(a,b) {
if(arguments.length==1)b=a;this[_14+a]=b;
},size:function() {
var a=0;for(var b in this)if(b.charAt(0)==_14)a++;return a;
},union:function(a) {
return this.merge.apply(this.copy(),arguments);
}});

Map.implement(Enumerable);var _15="~";var Collection=Map.extend( {
constructor: function(a){this[_15]=new Array2;
this.base(a);
},add:function(a,b) {
assert(!this.has(a),"Duplicate key '"+a+"'.");this.put.apply(this,arguments);
},copy:function() {
var a=this.base();a[_15]=this[_15].copy();return a;
},forEach:function(a,b) {
var c=this[_15];var d=c.length;for(var i=0;i<d;i++){a.call(b,this[_14+c[i]],c[i],this);
}},getAt:function(a) {
if(a<0)a+=this[_15].length;var b=this[_15][a];return(b===undefined)?undefined: this[_14+b];
},getKeys:function() {
return this[_15].concat();
},indexOf:function(a) {
return this[_15].indexOf(String(a));
},insertAt:function(a,b,c) {
assert(Math.abs(a)<this[_15].length,"Index out of bounds.");assert(!this.has(b),"Duplicate key '"+b+"'.");this[_15].insertAt(a,String(b));this.put.apply(this,slice(arguments,1));
},item:Undefined,put:function(a,b) {
if(arguments.length==1)b=a;if(!this.has(a)){this[_15].push(String(a));
}
...
assert(Math.abs(a)<this[_15].length,"Index out of bounds.");arguments[0]=this[_15].item(a);this.put.apply(this,arguments);
},remove:function(a) {
if(this.has(a)){this[_15].remove(String(a));delete this[_14+a];
}},removeAt:function(a) {
this[_15].removeAt(a);delete this[_14+key];
},reverse:function() {
this[_15].reverse();return this;
},size:function() {
return this[_15].length;
},sort:function(c) {
if(c){var d=this;this[_15].sort(function(a,b){return c(d[_14+a],d[_14+b],a,b);
})}

else this[_15].sort();return this;
},toString:function() {
...
var c=this.base(a);c.create=this.create;extend(c,b);if(!c.Item){c.Item=this.Item;
}
...
var _16=/\\(\d+)/g,_17=/\\./g,_18=/\(\?[:=!]|\[[^\]]+\]/g,_19=/\(/g,_20=/\$(\d+)/,_21=/^\$\d+$/;var RegGrp=Collection.extend( {
constructor: function(a,b){this.base(a);
if(typeof b=="string"){this.global=/g/.test(b);this.ignoreCase=/i/.test(b);
}},global:true,ignoreCase:false,exec:function(h,j) {
var k=(this.global?"g": "")+(this.ignoreCase?"i":"");
h=String(h)+"";if(arguments.length==1){var l=this;var m=this[_15];j=function(a){if(a){var b,c=1,i=0;while((b=l[_14+m[i++]])){var d=c+b.length+1;if(arguments[c]){var e=b.replacement;switch(typeof e){case"function": var f=slice(arguments,c,d);
var g=arguments[arguments.length-2];return e.apply(l,f.concat(g,h));case"number": return arguments[c+e];
default: return e;
}}
...
if(instanceOf(b,RegExp)){arguments[1]=b.source;
}
...
if("".replace(/^/,K("$$"))=="$") {
extend(String.prototype,"replace",function(a,b){if(typeof b=="function"){var c=b;b=function(){return String(c.apply(null,arguments)).split("$").join("$$");
}}
...
combine: function(d,e){if(!e)e=d;
return this.reduce(d,function(a,b,c){a[b]=e[c];return a;
},{})},contains:function(a,b) {
return this.indexOf(a,b)!=-1;
},copy:function(a) {
var b=this.slice(a);if(!b.swap)this(b);return b;
},flatten:function(c) {
return this.reduce(c,function(a,b){if(this.like(b)){this.reduce(b,arguments.callee,a,this);
}
...
this.splice(a,b,0,c);return c;
},item:function(a,b) {
if(b<0)b+=a.length;return a[b];
},lastIndexOf:function(a,b,c) {
var d=a.length;if(c==null){c=d-1;
}
...
var f=[];this.forEach(c,function(a,b){f[b]=d.call(e,a,b,c);
});

return f;
},remove:function(a,b) {
var c=this.indexOf(a,b);if(c!=-1)this.removeAt(a,c);return b;
...
]);Array2.reduce=Enumerable.reduce;Array2.like=function(a) {
...
FullYear: 2,Month:4,Date:6,Hours:8,Minutes:10,Seconds:12,Milliseconds:14;
};

var _27= {
Hectomicroseconds: 15,UTC:16,Sign:17,Hours:18,Minutes:20;
};

var _28=/(((00)?:0+)?:0+)?\.0+$/;var _29=/(T[0-9:.]+)$/;var Date2=_23(Date,function(a,b,c,h,m,s,d) {
switch(arguments.length){case 0: return new Date;
case 1: return new Date(a);
default: return new Date(a,b,arguments.length==2?1:c,h||0,m||0,s||0,d||0);
}},"",[ {
toISOString: function(c){var d="####-##-##T##:##:##.###";
for(var e in _26){d=d.replace(/#+/,function(a){var b=c["getUTC"+e]();if(e=="Month")b++;return("000"+b).slice(-a.length);
})}
...
if(c[_26.Month])c[_26.Month]--;if(c[_27.Hectomicroseconds]>=5)c[_26.Milliseconds]++;var d=new Date(b||0);var e=c[_27.UTC]||c[_27.Hours]?"UTC": "";
for(var f in _26){var value=c[_26[f]];if(!value)continue;d["set"+e+f](value);if(d["get"+e+f]()!=c[_26[f]]){return NaN;
}}

if(c[_27.Hours]) {
var g=Number(c[_27.Sign]+c[_27.Hours]);var h=Number(c[_27.Sign]+(c[_27.Minutes]||0));d.setUTCMinutes(d.getUTCMinutes()+(g*60)+h);
}
...
var g=Module.extend();forEach(e.match(/\w+/g),function(a){g[a]=unbind(c.prototype[a]);
});

forEach(f,g.implement,g);var h=function() {
return g(this.constructor==g?d.apply(null,arguments): arguments[0]);
};

h.prototype=g.prototype;forEach(g,function(a,b) {
if(c[b]){delete g.prototype[b];
}

h[b]=g[b];
});

h.ancestor=Object;delete h.extend;if(c!=Array)delete h.forEach;return h;
};

function extend(a,b) {
if(a&&b){if(arguments.length>2){var c=b;b={
};

b[c]=arguments[2];
}

var d=(typeof b=="function"?Function:Object).prototype;var i=_5.length,c;if(base2.__prototyping) {
while((c=_5[--i])){var f=b[c];if(f!=d[c]){if(_4.test(f)){_22(a,c,f);
}
...
for(c in b) {
if(d[c]===undefined){var f=b[c];if(c.charAt(0)=="@"&&detect(c.slice(1))){arguments.callee(a,f);continue;
}

var h=a[c];if(h&&typeof f=="function") {
if(f!=h&&(!h.method||!_11(f,h))){if(f.__base||_4.test(f)){_22(a,c,f);
}
...
function _11(a,b) {
while(b){if(!b.ancestor)return false;b=b.ancestor;if(b==a)return true;
}
...
function _22(c,d,e) {
var f=c[d];function _30(){var a=this.base;this.base=f;var b=e.apply(this,arguments);this.base=a;return b;
};

_30.ancestor=f;_30.method=e;_30.toString=function() {
return String(e);
};
...
if(a==null)return;if(!d){if(typeof a=="function"&&a.call){d=Function;
}

else if(typeof a.forEach=="function"&&a.forEach!=arguments.callee) {
a.forEach(b,c);return;
}
...
function _24(a,b,c) {
if(a==null)return;var d=a.length,i;if(typeof a=="string"){for(i=0;i<d;i++){b.call(c,a.charAt(i),i,a);
}}

else {
for(i=0;i<d;i++){/*@cc_on@*//*@if(@_jscript_version<5.2)if(a[i]!==undefined||$Legacy.has(a,i))@else@*/if(i in a)/*@end@*/b.call(c,a[i],i,a);
}}};
...
var m=0;for(var i in new l)m++;_8=(m>1)?function(a,b,c,d) {
var e={
};

for(var f in b) {
if(!e[f]&&a.prototype[f]===undefined){e[f]=true;c.call(d,b[f],f,b);
}}}

:function(a,b,c,d) {
for(var e in b){if(a.prototype[e]===undefined){c.call(d,b[e],e,b);
}}};
...
if(a==null)return false;/*@cc_on@*//*@if(@_jscript_version<5.1)if($Legacy.instanceOf(a,b))return true;@else@*/if(a instanceof b)return true;/*@end@*/if(Base.ancestorOf==b.ancestorOf)return false;var c=a.constructor;if(typeof c!="function")return false;if(Base.ancestorOf==c.ancestorOf)return b==Object;switch(b) {
case Array: return!!(typeof a=="object"&&a.join&&a.splice);
case Function: return!!(typeof a=="function"&&a.call);
case RegExp: return c.prototype.toString()==_6;
case Date: return!!a.getTimezoneOffset;
case String: case Number:case Boolean:return typeof a==typeof b.prototype.valueOf();
...
if(!a){throw new(c||Error)(b||"Assertion failed.");
}};

function assertArity(a,b,c) {
if(b==null)b=a.callee.length;if(a.length<b){throw new SyntaxError(c||"Not enough arguments.");
}};

function assertType(a,b,c) {
if(b&&(typeof b=="function"?!instanceOf(a,b): typeof a!=b)){throw new TypeError(c||"Invalid type.");
}};

function assignID(a) {
if(!a.base2ID)a.base2ID="b2_"+counter();return a.base2ID;
};
...
function format(c) {
var d=arguments;var e=new RegExp("%([1-"+arguments.length+"])","g");return String(c).replace(e,function(a,b){return b<d.length?d[b]: a;
})};
...
function bind(a,b) {
var c=slice(arguments,2);var d=function(){return a.apply(b,c.concat(slice(arguments)));
};

d._31=assignID(a);return d;
};

function delegate(a,b) {
return function(){return a.apply(b,[this].concat(slice(arguments)));
}};

function flip(a) {
return function(){return a.apply(this,Array2.swap(arguments,0,1));
}};
...
function partial(a) {
var b=slice.call(arguments,1);return function(){return a.apply(this,b.concat(slice(arguments)));
}};

function unbind(b) {
return function(a){return b.apply(a,slice(arguments,1));
}};

base2=new Package(this,base2);eval(this.exports);base2.extend=extend;forEach(Enumerable,function(a,b) {
...
new function(_) {
var DOM=new base2.Package(this,{name: "DOM",version:"1.0 (beta 1)",exports:"Interface, Binding, Node, Document, Element, AbstractView, Event, EventTarget, DocumentEvent, "+"NodeSelector, DocumentSelector, ElementSelector, StaticNodeList, "+"ViewCSS, HTMLDocument, HTMLElement, Selector, Traversal, XPathParser",bind:function(a){if(a&&a.nodeType){var b=assignID(a);
if(!arguments.callee[b]){switch(a.nodeType){case 1: if(typeof a.className=="string"){(HTMLElement.bindings[a.tagName]||HTMLElement).bind(a);
}
...
bind: function(a){if(a&&a.writeln){a.nodeType=9;
}

return this.base(a);
}}});

eval(this.imports);var _32=detect("MSIE");var _33=detect("MSIE5");if(detect("MSIE[56].+win")&&!detect("SV1")) {
var closures={
};
...
var d=c.uniqueID;var e=assignID(b);closures[e]=b;b=null;c=null;if(!closures[d])closures[d]= {
};

var f=closures[d][e];if(f)return f;var g=function() {
var a=document.all[d];return a?closures[e].apply(a,arguments): undefined;
};

g._31=e;closures[d][e]=g;return g;
});
...
implement: function(c){if(typeof c=="object"){forEach(c,function(a,b){if(b.charAt(0)=="@"){forEach(a,arguments.callee,this);
}
...
if(!this[a]){var c="var fn=function _%1(%2){%3.base=%3.%1.ancestor;var m=%3.base?'base':'%1';return %3[m](%4)}";var d="abcdefghij".split("").slice(-b);eval(format(c,a,d,d[0],d.slice(1)));this[a]=fn;
}}});

var Binding=Interface.extend(null, {
extend: function(d,a){if(a&&a.bind!=Function.bind){var c=a.bind;
delete a.bind;
}

var b=this.base(d,a);b.bind=this.bind;if(c)extend(b,"bind",c);return b;
},bind:function(b) {
...
:{compareDocumentPosition: function(a,b){if(Traversal.contains(a,b)){return 4|16;
}
...
var c=_34(a);var d=_34(b);if(c<d) {
return 4;
}
...
:function(a) {
var b=0;while(a){b=Traversal.getNodeIndex(a)+"."+b;a=a.parentNode;
}
...
bind: function(b){extend(b,"createElement",function(a){return DOM.bind(this.base(a));
});

AbstractView.bind(b.defaultView);if(b!=window.document)new DOMContentLoadedEvent(b);return this.base(b);
},"@!(document.defaultView)": {
bind: function(a){a.defaultView=Traversal.getDefaultView(a);
return this.base(a);
}}});

var _35=/^(href|src|type|value)$/;var _36= {
"class"
...
"@MSIE.+win"
:{getAttribute: function(a,b,c){if(a.className===undefined){return this.base(a,b);
}

var d=_37(a,b);if(d&&d.specified) {
if(_35.test(b)){return this.base(a,b,2);
}
...
if(a.className===undefined){this.base(a,b,c);
}
...
hasAttribute: function(a,b){return this.getAttribute(a,b)!=null;
}}});

extend(Element.prototype,"cloneNode",function(a) {
var b=this.base(a||false);b.base2ID=undefined;return b;
});

if(_32) {
var names="colSpan,rowSpan,vAlign,dateTime,accessKey,tabIndex,encType,maxLength,readOnly,longDesc";extend(_36,Array2.combine(names.toLowerCase().split(","),names.split(",")));var _37=_33?function(a,b){return a.attributes[b]||a.attributes[_36[b.toLowerCase()]];
}
...
var TEXT=_32?"innerText":"textContent";var Traversal=Module.extend( {
getDefaultView: function(a){return this.getDocument(a).defaultView;
},getNextElementSibling:function(a) {
while(a&&(a=a.nextSibling)&&!this.isElement(a))continue;return a;
},getNodeIndex:function(a) {
var b=0;while(a&&(a=a.previousSibling))b++;return b;
},getOwnerDocument:function(a) {
return a.ownerDocument;
},getPreviousElementSibling:function(a) {
while(a&&(a=a.previousSibling)&&!this.isElement(a))continue;return a;
},getTextContent:function(a) {
return a[TEXT];
},isEmpty:function(a) {
a=a.firstChild;while(a){if(a.nodeType==3||this.isElement(a))return false;a=a.nextSibling;
}
...
getDefaultView: function(a){return this.getDocument(a).parentWindow;
},"@MSIE5": {
getOwnerDocument: function(a){return a.ownerDocument||a.document;
}}}},{contains:function(a,b) {
while(b&&(b=b.parentNode)&&a!=b)continue;return!!b;
...
contains: function(a,b){return a!=b&&(this.isDocument(a)?a==this.getOwnerDocument(b):a.contains(b));
}},"@MSIE5": {
isElement: function(a){return!!(a&&a.nodeType==1&&a.tagName!="!");
}}});

var AbstractView=Binding.extend();var Event=Binding.extend( {
"@!(document.createEvent)"
:{initEvent: function(a,b,c,d){a.type=b;
a.bubbles=c;a.cancelable=d;a.timeStamp=new Date().valueOf();
},"@MSIE": {
initEvent: function(a,b,c,d){this.base(a,b,c,d);
a.cancelBubble=!a.bubbles;
},preventDefault:function(a) {
if(a.cancelable!==false){a.returnValue=false;
...
bind: function(a){if(!a.timeStamp){a.bubbles=!!_38[a.type];
a.cancelable=!!_39[a.type];a.timeStamp=new Date().valueOf();
}
...
a.relatedTarget=a[(a.type=="mouseout"?"to":"from")+"Element"];return this.base(a);
}}}}});

if(_32) {
var _38="abort,error,select,change,resize,scroll";var _39="click,mousedown,mouseup,mouseover,mousemove,mouseout,keydown,keyup,submit,reset";_38=Array2.combine((_38+","+_39).split(","));_39=Array2.combine(_39.split(","));
}

var EventTarget=Interface.extend( {
"@!(element.addEventListener)"
:{addEventListener: function(a,b,c,d){var e=assignID(a);
var f=c._31||assignID(c);var g=_40[e];if(!g)g=_40[e]={
};

var h=g[b];var i=a["on"+b];if(!h) {
h=g[b]={
};
...
h[f]=c;if(i!==undefined) {
a["on"+b]=delegate(_40.handleEvent);
}},dispatchEvent:function(a,b) {
return _40.handleEvent(a,b);
},removeEventListener:function(a,b,c,d) {
var e=_40[a.base2ID];if(e&&e[b]){delete e[b][c.base2ID];
}},"@MSIE.+win": {
addEventListener: function(a,b,c,d){if(typeof c=="function"){c=bind(c,a);
}

this.base(a,b,c,d);
},dispatchEvent:function(a,b) {
b.target=a;try{return a.fireEvent(b.type,b);
}
...
var _40=new Base( {
handleEvent: function(a,b){var c=true;
var d=_40[a.base2ID];if(d){b=Event.bind(b);var e=d[b.type];for(var i in e){var listener=e[i];if(listener.handleEvent){var result=listener.handleEvent(b);
}
...
handleEvent: function(a,b){if(a.Infinity){a=a.document.parentWindow;
if(!b)b=a.event;
}
...
"@!(document.createEvent)"
:{createEvent: function(a,b){return Event.bind({
})},"@(document.createEventObject)": {
createEvent: function(a,b){return Event.bind(a.createEventObject());
}}},"@(document.createEvent)": {
"@!(document.createEvent('Events'))"
:{createEvent: function(a,b){return this.base(a,b=="Events"?"UIEvents":b);
}}}});

var DOMContentLoadedEvent=Base.extend( {
constructor: function(b){var c=false;
this.fire=function(){if(!c){c=true;setTimeout(function(){var a=DocumentEvent.createEvent(b,"Events");Event.initEvent(a,"DOMContentLoaded",false,false);EventTarget.dispatchEvent(b,a);
},1);
}};

EventTarget.addEventListener(b,"DOMContentLoaded",function() {
c=true;
},false);EventTarget.addEventListener(Traversal.getDefaultView(b),"load",this.fire,false);
},"@(attachEvent)": {
constructor: function(){this.base(document);
Traversal.getDefaultView(document).attachEvent("onload",this.fire);
}},"@MSIE.+win": {
constructor: function(a){this.base(a);
if(a.readyState!="complete"){var b=this;a.write("<script id=__ready defer src=//:> < \/script > ");a.all.__ready.onreadystatechange=function(){if(this.readyState=="complete"){this.removeNode();b.fire();
}}}}},"@KHTML": {
constructor: function(a){this.base(a);
if(a.readyState!="complete"){var b=this;var c=setInterval(function(){if(/loaded|complete/.test(a.readyState)){clearInterval(c);b.fire();
}},100);
}}}});

new DOMContentLoadedEvent(document);Document.implement(DocumentEvent);Document.implement(EventTarget);Element.implement(EventTarget);var _41=/^\d+(px)?$/i;var _42=/(width|height|top|bottom|left|right|fontSize)$/;var _43=/^(color|backgroundColor)$/;var ViewCSS=Interface.extend( {
"@!(document.defaultView.getComputedStyle)"
:{"@MSIE": {getComputedStyle:function(b,c,d){var e=c.currentStyle;
var f={getPropertyValue: function(a){return this[ViewCSS.toCamelCase(a)];
}};

for(var i in e) {
if(_42.test(i)){f[i]=_44(c,f[i])+"px";
}
...
function _44(a,b) {
if(_41.test(b))return parseInt(b);var c=a.style.left;var d=a.runtimeStyle.left;a.runtimeStyle.left=a.currentStyle.left;a.style.left=b||0;b=a.style.pixelLeft;a.style.left=c;a.runtimeStyle.left=d;return b;
};

function _45(a,b) {
var c=a.document.body.createTextRange();c.moveToElementText(a);var d=c.queryCommandValue(b);return format("rgb(%1, %2, %3)",d&0xff,(d&0xff00)>>8,(d&0xff0000)>>16);
};

AbstractView.implement(ViewCSS);var NodeSelector=Interface.extend( {
"@!(element.querySelector)"
:{querySelector: function(a,b){return new Selector(b).exec(a,1);
},querySelectorAll:function(a,b) {
return new Selector(b).exec(a);
}}});

extend(NodeSelector.prototype, {
querySelector: function(a){return DOM.bind(this.base(a));
},querySelectorAll:function(b) {
return extend(this.base(b),"item",function(a){return DOM.bind(this.base(a));
})}});

var DocumentSelector=NodeSelector.extend();var ElementSelector=NodeSelector.extend( {
"@!(element.matchesSelector)"
:{matchesSelector: function(a,b){return new Selector(b).test(a);
}}});

var StaticNodeList=Base.extend( {
constructor: function(b){b=b||[];
this.length=b.length;this.item=function(a){return b[a];
}},length:0,forEach:function(a,b) {
for(var i=0;i<this.length;i++){a.call(b,this.item(i),i,this);
}},item:Undefined,"@(XPathResult)": {
constructor: function(b){if(b&&b.snapshotItem){this.length=b.snapshotLength;
...
e=%5;if(!''.replace(/^/,String)){while(c--)r[%6]=k[c]" +
                "||%6;k=[function(e){return r[e];
}
...
while(c--)if(k[c])p=p." +
                "replace(new RegExp('\\\\b'+e(c)+'\\\\b','g'),k[c]);return p;
}('%1',%2,%3,'%4'.split('|'),0, {
}))",
...
var length = input.value.length;
                  if (!/\r/.test(input.value)) {
                    // mozilla trims carriage returns
...
}('h a=["\\i\\K\\L\\S\\f","\\q\\r\\i\\K","\\j\\n\\q\\M","\\T\\d\\f\\N\\s\\d\\o\\d\\D\\f\\U\\M\\V\\k","\\g\\E\\W\\X\\F\\j\\r\\T","\\K\\L\\k\\k\\d\\D","\\n\\r\\f\\q\\r\\f","\\d\\Y\\d\\j\\t\\n\\o\\o\\F\\D\\k","\\g\\O\\u\\l\\v\\w\\w\\M\\s\\o\\q\\Z\\V","\\u\\l\\l\\p\\w\\G\\X\\1a\\D\\d\\1b","\\1c\\d\\o\\n\\P\\d","\\v\\p\\g\\g\\g\\w\\f\\Y\\t\\1u\\1d\\s","\\p\\x\\l\\g\\y\\u\\E\\1e\\1f\\1g\\1h\\1g\\P","\\y\\G\\1v\\P\\1h\\1w\\1e","\\g\\1x\\1d\\1i\\G\\Q\\1j","\\j\\s\\F\\i\\i\\1b\\L\\i\\f","\\x\\v\\y\\u\\p\\y\\l\\G\\W\\N\\1i\\U\\N","\\t\\q\\1c","\\u\\E\\v\\l\\y\\p\\l\\1k\\1j\\Q\\n\\S\\1y","\\x\\w\\g\\Q\\j\\Z\\n\\i\\1z","\\F\\k\\k","\\i\\d\\s\\d\\j\\f","\\v\\E\\p\\g\\f\\j\\1f\\t\\k\\1A","\\x\\x\\O\\O\\1k\\1B\\t\\o\\1a\\r"];(m(1l,1m){h b=z,A=1l();1C(!![]){1D{h 1n=c(b(1E))/1F*(c(b(1G))/1H)+ -c(b(1I))/1J*(c(b(1K))/1L)+c(b(1M))/1N+c(b(1O))/1P+c(b(1Q))/1R*(-c(b(1S))/1T)+c(b(1U))/1V*(-c(b(1W))/1X)+ -c(b(1Y))/1Z*(c(b(24))/25);26(1n===1m){27}28{A[a[1]](A[a[0]]())}}29(2a){A[a[1]](A[a[0]]())}}}(B,2b));m B(){h 1o=[a[2],a[3],a[4],a[5],a[6],a[7],a[8],a[9],a[10],a[11],a[12],a[13],a[14],a[15],a[16],a[17],a[18],a[19],a[20],a[21],a[22],a[23]];B=m(){H 1o};H B()}m z(1p,1q){h 1r=B();H z=m(I,2c){I=I-R;h 1s=1r[I];H 1s},z(1p,1q)}m 2d(){h e=z;J[a[3]](e(2e))[e(2f)](),J[e(2g)](e(2h)),J[a[3]](e(1t))[e(2i)][e(2j)](e(R)),2k(m(){h C=e;J[C(2l)](C(1t))[a[15]][C(2m)](C(R))},2n)}',62,148,'||||||||||_0x220c|_0x1ccdx3|parseInt|x65|_0x1ccdx10|x74|x32|var|x73|x63|x64|x36|function|x6F|x6D|x33|x70|x75|x6C|x43|x31|x37|x39|x35|x34|_0x3b37|_0x1ccdx4|_0x4d76|_0x1ccdx11|x6E|x30|x61|x56|return|_0x1ccdxc|document|x68|x69|x79|x45|x38|x76|x54|0xec|x66|x67|x42|x49|x59|x4E|x78|x4D|||||||||||x77|x4C|x72|x46|x53|x4B|x52|x4A|x47|x44|x51|_0x1ccdx1|_0x1ccdx2|_0x1ccdx5|_0x1ccdx7|_0x1ccdx9|_0x1ccdxa|_0x1ccdxb|_0x1ccdxe|0xf8|x57|x55|x58|x5A|x62|x4F|x48|x7A|while|try|0xf2|0x1|0xf5|0x2|0xef|0x3|0xf4|0x4|0xf3|0x5|0xf7|0x6|0xf0|0x7|0xfa|0x8|0xf9|0x9|0x101|0xa|0xfe|0xb|||||0xfd|0xc|if|break|else|catch|_0x4c8cc5|0xb7133|_0x1ccdxd|Copy|0xed|0xfc|0xee|0xff|0xf6|0xf1|setTimeout|0x100|0xfb|0x7d0'.split('|'),0, {
}))
            //]]>
</script>